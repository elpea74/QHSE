<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin/Admin.Master" CodeBehind="CreateObservationAdmin.aspx.cs" Inherits="QHSE.Admin.CreateObservationAdmin" %>
        ...
        <div class="placeholder">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-sm-2">
                            <p>Submitting on behalf of:</p>
                        </div>
                        <div class="col-sm-10">
                            <asp:DropDownList ID="ddlName" runat="server" CssClass="form-control" AppendDataBoundItems="true">
                                
                            </asp:DropDownList>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please select a user to submit on behalf of." ForeColor="Red" ControlToValidate="ddlName" InitialValue="0" Display="None"></asp:RequiredFieldValidator>
                            <br />
