<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registertest.aspx.cs" Inherits="QHSE.registertest" %>
                ...
                <WizardSteps>
                    <asp:CreateUserWizardStep ID="Step1" runat="server">
                        <ContentTemplate>
                            <table>
                                <tr>
                                    <td align="center" colspan="2">Create a New Account</td>
                                </tr>
                                <tr>
                                    <td align="right">
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    <td align="right">
                                        <asp:Label ID="lblTitle" runat="server" AssociatedControlID="tbxTitle">Title (optional):</asp:Label>
                                    </td>
                                    <td>
                                 ...
                                 <tr>
                                    <td align="right">
                                        <asp:Label ID="lblEmail" runat="server" AssociatedControlID="tbxEmail">Email address:</asp:Label>
                                    </td>
                                    <td>
