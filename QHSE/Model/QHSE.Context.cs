...
namespace QHSE.Model
{
    ...
    public partial class QHSEEntities : DbContext
    {
        public QHSEEntities()
            : base("name=QHSEEntities")
        {
        }
        ...
        public virtual ObjectResult<spObservationReport_Result> spObservationReport(Nullable<int> year, Nullable<int> p2)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spObservationReport_Result>("spObservationReport", yearParameter, p2Parameter);
        }
    
        public virtual ObjectResult<Nullable<int>> spRegisteruser(string name, string title, Nullable<int> departmentId, string userName, string password, string email, string role)
        {
            var nameParameter = name != null ?
                new ObjectParameter("Name", name) :
                new ObjectParameter("Name", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("spRegisteruser", nameParameter, titleParameter, departmentIdParameter, userNameParameter, passwordParameter, emailParameter, roleParameter);
        }
    }
}
