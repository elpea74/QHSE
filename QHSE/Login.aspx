<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="QHSE.Login" %>
...
<head runat="server">
    ...
    <title>QHSE Safety Reporting System</title>
    <style>
        .placeholder {
            width: 25%;
            height: 50%;
...
<body>
    ...
    <form id="form1" runat="server" class="form-horizontal">
        ...
        <div class="container-fluid">
                ...
                <h4><b>Login to QHSE Safety Reporting System</b></h4>
                <br />
