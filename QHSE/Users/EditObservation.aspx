<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditObservation.aspx.cs" MasterPageFile="~/Users/Users.Master" Inherits="QHSE.Users.EditObservation" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Edit Observation Card</title>
</asp:Content>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <p>Upload a replacement photo 上传替换照片:</p>
                        </div>
                        <div class="col-sm-10">
