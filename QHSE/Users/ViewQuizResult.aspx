<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Users/Users.Master" CodeBehind="ViewQuizResult.aspx.cs" Inherits="QHSE.Users.ViewQuizResult" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   ...
   table.mylist label {
    ...
    <div class="placeholder">
       ...
       Your score - 你的分数: <asp:Label ID="lblScore" runat="server" Text=""></asp:Label>
       <div class="grid">
           <br />
           <br />
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="" SortExpression="Description">
                ...
                <ItemTemplate>
                    ...
                    <br />
                    <br />
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:QHSEConnectionString %>" SelectCommand="SELECT Description FROM [QuestionOption] WHERE ([QuestionId] = @QuestionId)">
                        <SelectParameters>
...
<RowStyle Height="100px"></RowStyle>
        ...
        <div class="text-center">
            <asp:Button ID="btnResultList" runat="server" Text="Back to your Quiz Results" OnClick="btnResultList_Click" />
            <br />
            <br />
        </div>
        </div>
